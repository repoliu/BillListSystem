...
//        this.sheetName = sheetName;
    ...
    public List<List<String[]>> process() throws IOException, OpenXML4JException, ParserConfigurationException, SAXException {
        ...
        while (iter.hasNext()) {
            ...
            if (!CommonUtil.isNull(sheetNameTemp)) {
     ...
     * @throws IOException
     */
    public static List<String[]> readerExcel(String path, int minColumns) throws IOException, OpenXML4JException, ParserConfigurationException, SAXException {
        OPCPackage p = OPCPackage.open(path, PackageAccess.READ);
        XLSXCovertCSVReader xlsx2csv = new XLSXCovertCSVReader(p, System.out, minColumns);
        List<List<String[]>> lists = xlsx2csv.process();
        p.close();
...
//        List<String[]> list = XLSXCovertCSVReader.readerExcel("/Users/liuq/Projects/BillListSystem/src/main/webapp/ticket/20191219/A69E51EC7F2CFC2911852DDF51FD7DD4.xlsx", 11);
