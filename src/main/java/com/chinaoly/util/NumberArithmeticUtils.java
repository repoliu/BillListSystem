...
public class NumberArithmeticUtils {
    ...
    public static BigDecimal safeSubtract(Boolean isZero, BigDecimal b1, BigDecimal... bn) {
        if (null == b1) {
            b1 = BigDecimal.ZERO.setScale(2,BigDecimal.ROUND_HALF_UP);
        }
        BigDecimal r = b1.setScale(2,BigDecimal.ROUND_HALF_UP);
        if (null != bn) {
            for (BigDecimal b : bn) {
                r = r.subtract((null == b ? BigDecimal.ZERO.setScale(2,BigDecimal.ROUND_HALF_UP) : b.setScale(2,BigDecimal.ROUND_HALF_UP)));
            }
        }
        return isZero ? (r.compareTo(BigDecimal.ZERO) == -1 ? BigDecimal.ZERO.setScale(2,BigDecimal.ROUND_HALF_UP) : r.setScale(2,BigDecimal.ROUND_HALF_UP)) : r.setScale(2,BigDecimal.ROUND_HALF_UP);
    }
